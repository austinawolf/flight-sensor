...
/**
 * @brief Registers an event handler with the driver
 * 
 * @param callback pointer to event handler callback
 * @param context pointer to context to pass to event handler
 * @return STATUS_OK on success
 */
